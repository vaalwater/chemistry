...
const ALLOTROPE_CARD = {
  ...
  tag: 'C / O / P / S / Si 五组',
  desc:
    '同样的原子，搭法不同就成了完全不同的东西：金刚石的空间网状、石墨的层状（虚线是范德华力）、C₆₀ 的足球分子。' +
    '还有 O₂ 与 O₃、白磷与红磷、斜方硫与单斜硫、晶体硅与无定形硅 —— 切换任一种，下方的性质会跟着结构一起变，' +
    '最后还有同位素 / 同素异形体 / 同分异构体辨析和小测。',
  bullets: ['11 种单质 3D 结构切换 · 性质联动', '四组易混概念对比卡片', '17 道判断题练到会区分'],
};
